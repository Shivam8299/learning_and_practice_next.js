...
function page() {
  return (
    <div>
        <h1 className='text-2xl md:text-3xl font-semibold text-center mb-4'> Login for Teacher</h1>
         <form className='flex flex-col items-center w-full'>
          ...
          <input className='outline-none p-3 border border-gray-400 w-full md:max-w-100 rounded-lg mb-4 px-4' placeholder='Teacher Id:'></input>
